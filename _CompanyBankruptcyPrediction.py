...
normalizedData = ((loadedData - loadedData.min()) /
                  (loadedData.max() - loadedData.min()))
...
model.add(tensorflow.keras.layers.Dense(
    190, activation="relu", kernel_initializer="glorot_normal"))
model.add(tensorflow.keras.layers.Dropout(dropoutRate))
model.add(tensorflow.keras.layers.Dense(
    380, activation="relu", kernel_initializer="glorot_normal"))
model.add(tensorflow.keras.layers.Dropout(dropoutRate))
model.add(tensorflow.keras.layers.Dense(
    380, activation="relu", kernel_initializer="glorot_normal"))
model.add(tensorflow.keras.layers.Dropout(dropoutRate))
model.add(
    tensorflow.keras.layers.Dense(190, activation="relu", kernel_initializer="glorot_normal"))
model.add(tensorflow.keras.layers.Dropout(dropoutRate))
model.add(tensorflow.keras.layers.Dense(
    95, activation="relu", kernel_initializer="glorot_normal"))
model.add(tensorflow.keras.layers.Dropout(dropoutRate))
model.add(tensorflow.keras.layers.Dense(
