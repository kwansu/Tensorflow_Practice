...
model.add(layers.Dense(196, activation="relu", kernel_initializer="glorot_normal"))
model.add(layers.Dropout(dropoutRate))
model.add(layers.Dense(784, activation="relu", kernel_initializer="glorot_normal"))
model.add(layers.Dropout(dropoutRate))
model.add(layers.Dense(784, activation="relu", kernel_initializer="glorot_normal"))
model.add(layers.Dropout(dropoutRate))
model.add(layers.Dense(196, activation="relu", kernel_initializer="glorot_normal"))
